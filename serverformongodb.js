...
app.post('/items',(req,res)=>{//post method use karte hai jab hame server se kuchh modify karna hota hai,ya database me kuchh add karna hota hai
//iss tarah se pura data banega,jo ham server ko bhejenge(ye ek API hai)
    res.send('data is saved');//response me ye data send kiya[agar koi iss address '/items' par post request karega to response me ye message aayega=>data is saved]
})
